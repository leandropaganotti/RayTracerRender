...
public:    
    Sphere( const Vector3 &center={0.0f}, const float &radius=1.0f, const Vector3 &color={1.0f});
...
inline
const std::pair<float, float> Sphere::texUV(const Vector3 &phit, size_t) const
{
